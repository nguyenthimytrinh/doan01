...
<div id="main_container">
    ...
    <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    <ul>
                    <li><a href="index.php?ac=thongtincanhan">Sửa đổi thông tin cá nhân</a></li>
                    </ul>
                </div>
                ...
                <div class="submenu">
                    <ul>
                    <li><a href="index.php?act=loaisanpham">Loại sản phẩm</a></li>
    ...
    <div class="right_content">
		...
		if ($act=="loaisanpham")
        {
            include "/include/loaisanpham.php";
        }
        if ($act=="del_sanpham")
        {
