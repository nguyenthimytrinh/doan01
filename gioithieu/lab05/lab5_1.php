...
print_r($_GET);
?><hr>
<a href="lab5_1.php?x=1&y=2&z=3">Link 1</a><br><?php // chỉ số là x,y,z ; giá trị là 1,2,3 ?>
<a href="lab5_1.php?x[]=1&x[]=2&y=3">Link 2</a><br><?php // chỉ số là 0,1,y ; giá trị là 1,2,3 ?>
<a href="lab5_1.php?mod=product&ac=detail&id=1">Link 3</a><br><?php // chỉ số là mod,ac,id; giá trị là product,detail,1 ?>
<a href="lab5_1.php?mod=product&ac=list&name=a&page=2">Link 4</a><br><?php // chỉ số là mod,ac,name,page; giá trị là product,detail,a,2 ?>
<hr>
<fieldset>
